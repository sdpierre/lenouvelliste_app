    ...
    > */}
          <ImageBackground
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
              ...
              <View style={{flex:1 }}></View>
              <TouchableOpacity style={{ backgroundColor: "#0089d0", width: 60, height: 30, justifyContent: "center", alignItems: "center" }}
              onPress={() => {
                this.props.navigation.navigate('SaveForLater');
              }}>
              <Text style={{ fontFamily: "Montserrat-SemiBold", color: "white" }}>Posts</Text>
            </TouchableOpacity>
              </View>
