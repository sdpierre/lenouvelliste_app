...
export const BASE_URL = 'https://api.lenouvelliste.com/api/';
...
export const kPasswordMinLength =
  'Password must contain at least 6 characters.';
export const kPasswordMaxLength =
...
export const kCitizenPostDescription = 'Please add description for post.';
